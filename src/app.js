...
function applyTheme(isDark) {
  ...
  if (iconEl) iconEl.outerHTML = isDark ? ICON_SUN.replace('<svg', '<svg id="themeIcon"') : ICON_MOON.replace('<svg', '<svg id="themeIcon"');
